...
--> statement-breakpoint
INSERT INTO `__new_user`("id", "name", "email", "email_verified", "image", "created_at", "updated_at", "is_admin") SELECT "id", "name", "email", "email_verified", "image", "created_at", "updated_at", "is_admin" FROM `user`;--> statement-breakpoint
