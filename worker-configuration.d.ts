/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a4c4ce199736e99b020c81fe412f41ad)
// Runtime types generated with workerd@1.20260603.1 2025-10-22 nodejs_compat
interface __BaseEnv_Env {
	R2: R2Bucket;
	DB: D1Database;
	VECTORIZE: Vectorize;
	KNOWLEDGE_INDEX_QUEUE: Queue;
	AI: Ai;
	R2_BUCKET_NAME: "poprag-staging" | "poprag";
	...
	CLOUDFLARE_R2_ACCOUNT_API_TOKEN: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	SERVICE_ACCOUNT_DATA: string;
	PRODUCT_CATALOG_TOKEN: string;
	CATALOG_SYNC_WORKFLOW: Workflow<Parameters<import("./src/server").CatalogSyncWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_BUCKET_NAME" | "BETTER_AUTH_URL" | "D1_TOKEN" | "D1_ACCOUNT_ID" | "D1_DATABASE_ID" | "OPENAI_API_KEY" | "OPENROUTER_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_ID" | "CLOUDFLARE_WORKERS_API_TOKEN" | "CLOUDFLARE_R2_ACCOUNT_API_TOKEN" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SERVICE_ACCOUNT_DATA" | "PRODUCT_CATALOG_TOKEN">> {}
}
